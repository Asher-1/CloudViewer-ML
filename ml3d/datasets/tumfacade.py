...
class TUMFacade(BaseDataset):
    ...
    def __init__(self,
        ...
        The dataset split is provided in the following folder structure
            ...
            To make use of the dataset split in CloudViewer-ML, all the point cloud
            files have to be unpacked with 7Zip. The folder structure itself
            must not be modified, else the reading functionalities in CloudViewer-ML
...
class TUMFacadeSplit(BaseDatasetSplit):
    ...
    def get_data(self, idx):
        ...
        data = cv3d.t.io.read_point_cloud(pc_path).point
