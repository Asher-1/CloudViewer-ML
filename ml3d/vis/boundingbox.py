...
class BoundingBox3D:
    ...
    def create_lines(boxes, lut=None):
        """Creates and returns an cloudViewer.geometry.LineSet that can be used to
        render the boxes.
        ...
        lines.points = cv3d.utility.Vector3dVector(points)
        lines.lines = cv3d.utility.Vector2iVector(indices)
