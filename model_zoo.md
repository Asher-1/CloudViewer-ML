...
For downloading these datasets visit the respective webpages and have a look at the scripts in [`scripts/download_datasets`](https://github.com/isl-org/CloudViewer-ML/tree/master/scripts/download_datasets).
