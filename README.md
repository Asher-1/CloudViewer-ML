...
<p align="center">
<img src="https://raw.githubusercontent.com/Asher-1/CloudViewer/master/docs/_static/open3d_logo_horizontal.png" width="320" />
...
CloudViewer-ML is an extension of CloudViewer for 3D machine learning tasks.
It builds on top of the CloudViewer core library and extends it with machine learning
...
CloudViewer-ML works with **TensorFlow** and **PyTorch** to integrate easily into
...
CloudViewer-ML is integrated in the CloudViewer v0.11+ python distribution and is
...
to 
[build CloudViewer from source](http://www.cloudViewer.org/docs/release/compilation.html).
...
[`scripts/semseg.py`](https://github.com/Asher-1/CloudViewer-ML/tree/master/scripts/semseg.py)
...
|--------------------|---------------|----------- |-------|
| RandLA-Net (tf)    | [53.7](https://storage.googleapis.com/cloudViewer-releases/model-zoo/randlanet_semantickitti_202010091306.zip) |  [69.0](https://storage.googleapis.com/cloudViewer-releases/model-zoo/randlanet_toronto3d_202010091250.zip) |  [67.0](https://storage.googleapis.com/cloudViewer-releases/model-zoo/randlanet_s3dis_202010091238.zip)    |
| RandLA-Net (torch) | [52.8](https://storage.googleapis.com/cloudViewer-releases/model-zoo/randlanet_semantickitti_202009090354utc.pth)        |     [71.2](https://storage.googleapis.com/cloudViewer-releases/model-zoo/randlanet_toronto3D_202010091306.pth)  |  [67.0](https://storage.googleapis.com/cloudViewer-releases/model-zoo/randlanet_s3dis_202010091238.pth)  |
| KPConv     (tf)    | [58.7](https://storage.googleapis.com/cloudViewer-releases/model-zoo/kpconv_semantickitti_202010021102utc.zip)         |     [65.6](https://storage.googleapis.com/cloudViewer-releases/model-zoo/kpconv_toronto3d_202010081102utc.zip)  |  [65.0](https://storage.googleapis.com/cloudViewer-releases/model-zoo/kpconv_s3dis_202010091238.zip) |
| KPConv     (torch) | [58.0](https://storage.googleapis.com/cloudViewer-releases/model-zoo/kpconv_semantickitti_202009090354utc.pth)          |     [65.6](https://storage.googleapis.com/cloudViewer-releases/model-zoo/kpconv_toronto3d_202010081102utc.pth) |  [60.0](https://storage.googleapis.com/cloudViewer-releases/model-zoo/kpconv_s3dis_202010091238.pth)  |


## Model Zoo

For a full list of all weight files see [model_weights.txt](https://storage.googleapis.com/cloudViewer-releases/model-zoo/model_weights.txt)
and the MD5 checksum file [model_weights.md5](https://storage.googleapis.com/cloudViewer-releases/model-zoo/integrity.txt).
...
CloudViewer is a community effort. We welcome and celebrate contributions from the
community!
...
* [Forum](https://forum.cloudViewer.org): discussion on the usage of CloudViewer.
